...
def run_scenario(
    ...
    return ScenarioRunResponse(
        ...
        auto_mitigations_triggered=int(result.get("auto_mitigations_applied", 0)),
        auto_mitigation_enabled=bool(result.get("auto_mitigation_enabled", False)),
        auto_escalate_after_count=int(result.get("auto_escalate_after_count", 1)),
        mode=mode_service.get_mode(),
